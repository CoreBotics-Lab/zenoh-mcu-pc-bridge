...
public:
    CounterSubscriberNode() : ZenohNode("counter_subscriber") {
        ...
        sub_ = this->z_create_subscription<z_std_msgs::z_Int32>(
            "robot/sim_counter",
...
private:
    ZenohSubscription<z_std_msgs::z_Int32>* sub_ = nullptr;

    void listener_callback(const z_std_msgs::z_Int32& msg) {
