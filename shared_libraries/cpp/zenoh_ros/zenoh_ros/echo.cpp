/**
 * zenoh_ros/echo.cpp — C++ High-Performance Topic Echo CLI Tool
 *
 * Echoes any topic in real-time over Zenoh. Auto-discovers peers or connects to host if supplied.
 */
...
int main(int argc, char** argv) {
    if (argc < 2) {
        ...
        std::cout << "Example: echo robot/mpu6050 192.168.4.1\n";
        return 1;
    }
    ...
    if (host && std::string(host).length() > 0) {
        ...
        std::cout << "[echo] Auto-discovering peers on network (AP/STA)...\n";
    }
